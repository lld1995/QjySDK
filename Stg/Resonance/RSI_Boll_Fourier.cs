...
namespace QjySDK.Stg
{
    ...
    public class RSI_Boll_Fourier : StgBase
    {
        ...
        public override StgDesc GetStgDesc()
        {
            ...
            sd.ArgDescDic["rsiOverbought"] = new ArgDesc() { Text = "RSI超买线", Explain = "RSI超买区域阈值，通常为70", Type = "number" };
            sd.ArgDescDic["rsiOversold"] = new ArgDesc() { Text = "RSI超卖线", Explain = "RSI超卖区域阈值，通常为30", Type = "number" };
            sd.ArgDescDic["bollPeriod"] = new ArgDesc() { Text = "布林带周期", Explain = "布林带计算周期，通常为20", Type = "number" };
            sd.ArgDescDic["bollStdDev"] = new ArgDesc() { Text = "标准差倍数", Explain = "布林带上下轨的标准差倍数，通常为2", Type = "number" };
