...
namespace QjySDK.Stg
{
    ...
    public class GBDTPredict : StgBase
    {
        ...
        public override StgDesc GetStgDesc()
        {
            ...
            sd.ArgDescDic["maxDepth"] = new ArgDesc() { Text = "最大深度", Explain = "决策树的最大深度", Type = "number" };
            sd.ArgDescDic["learningRate"] = new ArgDesc() { Text = "学习率", Explain = "模型训练学习率(收缩系数)", Type = "number" };
            sd.ArgDescDic["minSamplesLeaf"] = new ArgDesc() { Text = "叶子最小样本", Explain = "叶子节点最小样本数", Type = "number" };
            sd.ArgDescDic["minSamplesSplit"] = new ArgDesc() { Text = "分裂最小样本", Explain = "分裂所需最小样本数", Type = "number" };
            sd.ArgDescDic["subsample"] = new ArgDesc() { Text = "样本采样", Explain = "每棵树的样本采样比例", Type = "number" };
            sd.ArgDescDic["maxFeatures"] = new ArgDesc() { Text = "特征采样", Explain = "每棵树的特征采样比例", Type = "number" };
