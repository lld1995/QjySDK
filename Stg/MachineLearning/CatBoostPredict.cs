...
namespace QjySDK.Stg
{
    ...
    public class CatBoostPredict : StgBase
    {
        ...
        public override StgDesc GetStgDesc()
        {
            ...
            sd.ArgDescDic["numTrees"] = new ArgDesc() { Text = "树数量", Explain = "CatBoost中树的数量", Type = "number" };
            sd.ArgDescDic["maxDepth"] = new ArgDesc() { Text = "最大深度", Explain = "对称树的最大深度", Type = "number" };
            sd.ArgDescDic["learningRate"] = new ArgDesc() { Text = "学习率", Explain = "模型训练学习率", Type = "number" };
            sd.ArgDescDic["l2Regularization"] = new ArgDesc() { Text = "L2正则化", Explain = "L2正则化系数", Type = "number" };
            ...
            sd.ArgDescDic["randomStrength"] = new ArgDesc() { Text = "随机强度", Explain = "分割选择的随机性", Type = "number" };
