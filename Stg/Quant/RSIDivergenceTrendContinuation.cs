...
namespace QjySDK.Stg
{
    ...
    public class RSIDivergenceTrendContinuation : StgBase
    {
        ...
        public override StgDesc GetStgDesc()
        {
            ...
            sd.ArgDescDic["rsiExtremeOverbought"] = new ArgDesc() { Text = "RSI极度超买", Explain = "RSI极度超买阈值，默认80" };
            sd.ArgDescDic["rsiExtremeOversold"] = new ArgDesc() { Text = "RSI极度超卖", Explain = "RSI极度超卖阈值，默认20" };
            ...
            sd.ArgDescDic["maSlopeThreshold"] = new ArgDesc() { Text = "均线斜率阈值", Explain = "判断趋势强度的斜率阈值" };
            ...
            sd.ArgDescDic["tradingMode"] = new ArgDesc() { Text = "交易模式", Explain = "0:双模式 1:仅反转背离 2:仅趋势延续" };
            sd.ArgDescDic["requireMaFilter"] = new ArgDesc() { Text = "均线过滤", Explain = "0:不需要 1:需要均线方向过滤" };
            sd.ArgDescDic["requireMaAlignment"] = new ArgDesc() { Text = "均线排列", Explain = "0:不需要 1:需要均线多空排列确认" };
            sd.ArgDescDic["trendPullbackDepth"] = new ArgDesc() { Text = "回调深度", Explain = "趋势延续模式的回调深度阈值" };
            sd.ArgDescDic["minTrendBars"] = new ArgDesc() { Text = "最小趋势K线", Explain = "判断趋势的最小K线数" };
            ...
            sd.ArgDescDic["useMaCrossExit"] = new ArgDesc() { Text = "均线交叉出场", Explain = "0:不使用 1:使用均线死叉/金叉出场" };
