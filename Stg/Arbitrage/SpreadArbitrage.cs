...
namespace QjySDK.Stg
{
    ...
    public class SpreadArbitrage : StgBase
    {
        ...
        public override StgDesc GetStgDesc()
        {
            ...
            // ==================== 偏离度计算参数 ====================
            sd.ArgDescDic["lookbackPeriod"] = new ArgDesc { Text = "回溯周期", Explain = "计算累积偏离度和Z-Score的滚动窗口", Type = "number" };
            sd.ArgDic["lookbackPeriod"] = 60;

            sd.ArgDescDic["returnPeriod"] = new ArgDesc { Text = "收益率周期", Explain = "计算标准化收益率的K线间隔", Type = "number" };
            ...
            // ==================== Z-Score阈值 ====================
            sd.ArgDescDic["entryZScore"] = new ArgDesc { Text = "入场Z-Score", Explain = "偏离度Z-Score绝对值超过此值入场", Type = "number" };
            sd.ArgDic["entryZScore"] = 1.5;

            sd.ArgDescDic["exitZScore"] = new ArgDesc { Text = "出场Z-Score", Explain = "偏离度Z-Score绝对值低于此值出场", Type = "number" };
            sd.ArgDic["exitZScore"] = 0.3;

            sd.ArgDescDic["stopLossZScore"] = new ArgDesc { Text = "止损Z-Score", Explain = "偏离度Z-Score绝对值超过此值止损", Type = "number" };
            ...
            sd.ArgDescDic["minSymbols"] = new ArgDesc { Text = "最小品种数", Explain = "品种数低于此值不计算(样本不足)", Type = "number" };
            ...
            sd.ArgDescDic["atrStopMultiplier"] = new ArgDesc { Text = "ATR止损倍数", Explain = "额外ATR止损保护(0=禁用，仅用Z-Score止损)", Type = "number" };
            sd.ArgDic["atrStopMultiplier"] = 0.0;

            sd.ArgDescDic["maxPositions"] = new ArgDesc { Text = "最大持仓数", Explain = "同时持仓的最大品种数(0=不限制)", Type = "number" };
